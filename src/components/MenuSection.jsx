...
function Menu() {
    const menuItems = [
        ...
        },
        {
            ...
            description: 'Un gratin de pommes de terre parfumé à la truffe et cuit doucement dans du lait et de la crème. ',
            price: 12.12,
        ...
        },
        {
            ...
            description: 'Légumes de saison délicatement rôtis et nappés d\'un beurre noisette parfumé.',
            price: 10.97,
        ...
        },
        {
            ...
            description: 'Purée onctueuse de panais et pommes de terre, parfumée au beurre et à la crème.',
            price: 6.99,
        ...
        },
        {
            ...
            description: 'Riz Arborio crémeux cuisiné avec des champignons forestiers frais, parfumé au parmesan et à l\'huile de truffe.',
            price: 11.07,
        ...
        },
        {
            ...
            description: ' Asperges fraîches grillées avec une touche de sel de mer et un filet d\'huile d\'olive.',
            price: 10.10,
        ...
        },
        {
            ...
            description: 'Prosecco mélangé à une purée de pêche blanche pour un apéritif frais et pétillant.',
            price: 11.97,
        ...
        },
        {
            ...
            description: 'Servie fraîche, avec ou sans bulles selon votre préférence.',
            price: 14.87,
            image: '/img/eauMinerale.jpg',
        },
        {
            id: 35,
            name: 'Cocktail orange mimosa',
            description: 'Le cocktail Mimosa est un mélange élégant de champagne et de jus d\'orange frais, parfait pour un brunch ou une occasion festive.',
            price: 13.40,
            image: '/img/orangeMimosa.jpg',
        },
        {
            id: 36,
            name: 'Mojito',
            description: 'Le Mojito est un cocktail cubain à base de rhum, citron vert, menthe fraîche, sucre, eau gazeuse et glace pilée.',
            price: 12.17,
