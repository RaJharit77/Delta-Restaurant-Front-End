...
const Notifications = () => { 
    ...
    return (
        <div className="fixed bottom-5 right-5 bg-slate-900 bg-opacity-80 shadow-lg rounded-lg p-4 w-80 border border-gray-600 z-50">
            <p className="text-creme font-semibold text-lg text-left">Visitez notre hôtel !</p>
            <p className="text-gray-100 mt-2 text-left">
